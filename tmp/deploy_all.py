...
# ── Step 2: Frontend dist ──
print("\n[2/4] 部署前端 dist...")
run('rm -rf ' + FRONTEND_REMOTE + 'assets 2>/dev/null; rm -f ' + FRONTEND_REMOTE + 'index.html; mkdir -p ' + FRONTEND_REMOTE + 'assets')
...
try:
    req = urllib.request.Request('http://122.51.136.129/api/models')
