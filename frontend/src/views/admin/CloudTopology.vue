...
.top-bar h2 { font-size:18px; color:#1a1a2e; flex-shrink:0; }
.top-actions { display:flex; gap:12px; align-items:center; flex-wrap:wrap; }
.graph-wrapper { flex:1; background:#fff; border-radius:12px; position:relative; overflow:hidden; min-height:500px; }
...
.loading-overlay { position:absolute; top:0; left:0; right:0; bottom:0; background:rgba(255,255,255,0.8); display:flex; flex-direction:column; align-items:center; justify-content:center; gap:12px; color:#909399; }
